...
function edit_task(task_id) {
    //удаляю кнопку delete во время edit
    let identifier_delete = "#delete_" + task_id;
    $(identifier_delete).remove();

    //заменяю кнопку edit на save
    //edit_ -> tasks.html
